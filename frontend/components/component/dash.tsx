...
function Pottu(props){
  ...
  if(props.status == 1){
    ...
    return (<>
      <div className="flex flex-col items-center justify-center flex-1" style={{display: dis1}}>
              <h2 className="text-3xl font-bold text-white">Start taking notes!</h2>
              <p className="mt-2 text-center text-gray-400">Kickstart your practical learning with Peone!</p>
              <input
                type="file"
                onChange={props.change}
                className="text-sm text-gray-400 bg-gray-800 border border-gray-700 rounded p-2"
              />
              <Button className="mt-4 bg-green-500 text-white" onClick={props.upload}>Upload</Button>
      </div>
      <div><p className="mt-2 text-center text-gray-400" style={{display: dis2}}><Markdown className="mark">{props.content}</Markdown></p></div></>
    )
  }
    ...
    <div className="flex h-screen bg-[#121212]">
      <aside className="w-64 flex flex-col border-r border-gray-800">
        <div className="flex flex-col px-4 py-6">
          ...
          <div className="mt-6">
            <h3 className="text-xs font-semibold text-gray-400 uppercase">Subjects</h3>
        ...
        <div className="mt-auto flex items-center px-4 py-6">
          <Avatar>
            <AvatarImage alt="Ryan Lee" src="/placeholder.svg?height=32&width=32" />
      ...
      <main className="flex-1 p-6" style={{overflowY: 'scroll', textAlign: 'left'}}>
        <div className="flex flex-col h-full">
          <header className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-semibold text-white">Machine Learning</h1>
          ...
          <Pottu change={handleFileChange} upload={handleUpload} content={content} status={status}/>
